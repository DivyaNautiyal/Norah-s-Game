...
function draw() {
 ...
 if(lives>0 && c2!= 0){
  ...
  else if(mousePressedOver(pink1)){
    answer="pink"
    console.log(lives)
    lives=lives-1
    c2=0
  }
  else if(mousePressedOver(orange1) ){
    answer="orange"
    console.log(lives)
    lives=lives-1
    c2=0
  }
  else if(mousePressedOver(purple1)){
    answer="purple"
    console.log(lives)
    lives=lives-1
    c2=0
  }
  else if(mousePressedOver(white1)){
    answer="white"
    console.log(lives)
    lives=lives-1
    c2=0
  }
  else if(mousePressedOver(yellow1)){
    answer="yellow"
    console.log(lives)
    lives=lives-1
    c2=0
